...
<%@page import="ua.kpi.epam.transport.commands.schedule.ScheduleCommand"%>
...
<c:set var="FIND_ALL_SCHEDULES_FOR_ROUTE_COMMAND"
	value="<%=ScheduleCommandFactory.FIND_ALL_SCHEDULES_FOR_ROUTE_COMMAND%>" />
<c:set var="DELETE_SCHEDULE_COMMAND"
	value="<%=ScheduleCommandFactory.DELETE_SCHEDULE_COMMAND%>" />
<c:set var="SHOW_ADD_SCHEDULE_FORM_COMMAND"
	value="<%=ScheduleCommandFactory.SHOW_ADD_SCHEDULE_FORM_COMMAND%>" />
<c:set var="ADD_SCHEDULE_TO_STOP_COMMAND"
	value="<%=ScheduleCommandFactory.ADD_SCHEDULE_TO_STOP_COMMAND%>" />
<c:set var="CREATE_SCHEDULE_COMMAND"
	value="<%=ScheduleCommandFactory.CREATE_SCHEDULE_COMMAND%>" />
<c:set var="SET_TRANSPORT_ON_SCHEDULE"
	value="<%=ScheduleCommandFactory.SET_TRANSPORT_ON_SCHEDULE%>" />
<c:set var="SHOW_TRANSPORT_ON_SCHEDULE"
	value="<%=ScheduleCommandFactory.SHOW_TRANSPORT_ON_SCHEDULE%>" />
<c:set var="CREATE_SCHEDULE_USING_INTERVAL_COMMAND"
	value="<%=ScheduleCommandFactory.CREATE_SCHEDULE_USING_INTERVAL_COMMAND%>" />


<c:set var="ROUTE_ID_ATTRIBUTE"
	value="<%=ScheduleCommand.ROUTE_ID_ATTRIBUTE%>" />
<c:set var="SCHEDULE_ID_ATTRIBUTE"
	value="<%=ScheduleCommand.SCHEDULE_ID_ATTRIBUTE%>" />
<c:set var="STOP_ID_ATTRIBUTE"
	value="<%=ScheduleCommand.STOP_ID_ATTRIBUTE%>" />
<c:set var="TRANSPORT_ID_ATTRIBUTE"
	value="<%=ScheduleCommand.TRANSPORT_ID_ATTRIBUTE%>" />
<c:set var="ARRIVE_TIME_ATTRIBUTE"
	value="<%=ScheduleCommand.ARRIVE_TIME_ATTRIBUTE%>" />
<c:set var="LEAVE_TIME_ATTRIBUTE"
	value="<%=ScheduleCommand.LEAVE_TIME_ATTRIBUTE%>" />
<c:set var="INTERVAL_ATTRIBUTE"
	value="<%=ScheduleCommand.INTERVAL_ATTRIBUTE%>" />
<c:set var="INTERVAL_SIGN_ATTRIBUTE"
	value="<%=ScheduleCommand.INTERVAL_SIGN_ATTRIBUTE%>" />
							...
							<table>
								...
								<tr>
									...
									<td><c:set var="schedule_id"
											value="<%=request.getParameter(ScheduleCommand.SCHEDULE_ID_ATTRIBUTE)%>" />
