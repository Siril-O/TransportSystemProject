...
public class AddScheduleForStopCommandValidator implements CommandValidator {
    ...
    public boolean validate(HttpServletRequest request, HttpServletResponse response) {
        ...
        String stopErrorMessage = LocalizationHelper.getInstanse().getLocalizedMessage(request, STOP_OR_SCHEDULE_ERROR_MSG);
        String noTimeMessage = LocalizationHelper.getInstanse().getLocalizedMessage(request, TIME_ERROR_MSG);
        String badTimeMessage = LocalizationHelper.getInstanse().getLocalizedMessage(request, BAD_TIME_FORMAT_ERROR_MSG);
