...
public class CreateScheduleUsingIntervaCommandValidator implements CommandValidator {
    ...
    public boolean validate(HttpServletRequest request, HttpServletResponse response) {
        ...
        String badScheduleMessage = LocalizationHelper.getInstanse().getLocalizedMessage(request, SHEDULE_OR_TRANSPORT_ERROR_MSG);
        String emptyIntervalmessage = LocalizationHelper.getInstanse().getLocalizedMessage(request, INTERVAL_ERROR_MSG);
        String badIntervalmessage = LocalizationHelper.getInstanse().getLocalizedMessage(request, BAD_INTERVAL_ERROR_MSG);
